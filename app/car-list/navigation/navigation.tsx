...
<Image src="/foto.car/1.png" id='1' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but1}>RENT</button>
<h2 className={style.carName1}>Lamborghini Urus</h2>
    
<Image src="/foto.car/2.png"  id='2' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but2}>RENT</button>
<h2 className={style.carName2}>Ferrari Roma</h2>

<Image src="/foto.car/3.png"  id='3' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but3}>RENT</button>
<h2 className={style.carName3}>Rolls-Royce Ghost</h2>

<Image src="/foto.car/4.png"  id='4' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but4}>RENT</button>
<h2 className={style.carName4}>Porsche 911 Turbo S</h2>

<Image src="/foto.car/5.png"  id='5' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but5}>RENT</button>
<h2 className={style.carName5}>BMW M5 F90</h2>

<Image src="/foto.car/6.png"  id='6' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but6}>RENT</button>
<h2 className={style.carName6}>Mercedes-Benz G63</h2>

<Image src="/foto.car/7.png"  id='7' width={955} height={550} alt="car" className={style.foto}/>
<button className={style.but7}>RENT</button>
<h2 className={style.carName7}>Range Rover Sport</h2>

<Image src="/foto.car/8.png"  id='8' width={955} height={550} alt="car" className={style.foto}/>
